...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (iframeContainer && iframe && thumbnailContainer) {
        ...
        const iframeSources = {
            'indoor-thumb': 'http://localhost:8000/viser-client/?playbackPath=http://localhost:8000/assets/viser_recordings/indoor.viser&initialCameraPosition=-0.150,-0.300,0.05&initialCameraLookAt=0.000,0.000,0.000&initialCameraUp=-0.000,-0.000,1.000',
            'outdoor-thumb': 'http://localhost:8000/viser-client/?playbackPath=http://localhost:8000/assets/viser_recordings/outdoor.viser&initialCameraPosition=0.8,-0.556,0&initialCameraLookAt=-1,0,0'
        };
